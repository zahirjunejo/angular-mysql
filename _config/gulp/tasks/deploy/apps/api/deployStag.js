// =========================================================
// Gulp Task: deploystagingBackend
// Description:
// Dependencies:
// =========================================================
module.exports = function (gulp, $, config, utils) {
  return function (callback) {
    ...
    utils.exec(
      "cat " + config.paths.apiEnvironmentFilePath + "environment.staging.ts > " + config.paths.apiWorkingFolder + "environment.ts"
    );
    utils.exec(
      "cat " + config.paths.apiEnvironmentFilePath + "environment.staging.ts > " + config.paths.apiWorkingFolder + "environment.prod.ts"
    );
